...
HD_PWD='C:/Users/Al-YeeTan/Desktop/CSI 2.5G MIPI/au25p_mipi_csi_2-5g/MIPI_loopback_2-5g.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mipi_block_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mipi_block_top_wrapper.tcl
