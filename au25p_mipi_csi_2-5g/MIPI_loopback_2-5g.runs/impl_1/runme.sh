...
HD_PWD='C:/Users/Al-YeeTan/Desktop/CSI 2.5G MIPI/au25p_mipi_csi_2-5g/MIPI_loopback_2-5g.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mipi_block_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mipi_block_top_wrapper.tcl -notrace
