...
localparam RESET_LCD            = 26'd6;
localparam RELEASE_RESET_LCD    = 26'd12;
localparam RELEASE_RESET_ALL    = 26'd25;
...
always @(negedge i_arstn or posedge axi_clk) begin
    if (~i_arstn) begin
