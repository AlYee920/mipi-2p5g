...
#                script (type 'mipi_block_top.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Al-YeeTan/Desktop/MIPI_loopback_2-5g/MIPI_loopback_2-5g.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
