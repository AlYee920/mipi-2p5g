...
#
# Script generated by Vivado on Mon Jan 29 10:25:28 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : mipi_block_top.sh
...
#
# Usage        : mipi_block_top.sh
#                mipi_block_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mipi_block_top.sh [-reset_run]
#                mipi_block_top.sh [-reset_log]
#                mipi_block_top.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_14 -L smartconnect_v1_0 -L mipi_dphy_v4_3_6 -L xilinx_vip"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "mipi_block_top.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mipi_block_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L mipi_csi2_tx_ctrl_v1_0_4 -L high_speed_selectio_wiz_v3_6_5 -L mipi_dphy_v4_3_6 -L generic_baseblocks_v2_1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_28 -L fifo_generator_v13_2_8 -L axi_data_fifo_v2_1_27 -L axi_crossbar_v2_1_29 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L mipi_csi2_rx_ctrl_v1_0_8 -L axis_infrastructure_v1_1_0 -L axis_register_slice_v1_1_28 -L axis_dwidth_converter_v1_1_27 -L axis_switch_v1_1_28 -L vfb_v1_0_22 -L jtag_axi -L dist_mem_gen_v8_0_13 -L blk_mem_gen_v8_4_6 -L lib_bmg_v1_0_15 -L axi_traffic_gen_v3_0_14 -L xlconstant_v1_1_7 -L smartconnect_v1_0 -L axi_vip_v1_1_14 -L oddr_v1_0_2 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mipi_block_top xil_defaultlib.mipi_block_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mipi_block_top -key {Behavioral:sim_1:Functional:mipi_block_top} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/bd_7e2a.protoinst" -protoinst "protoinst_files/bd_782c.protoinst" -protoinst "protoinst_files/bd_b9b5.protoinst" -protoinst "protoinst_files/bd_f513.protoinst" -protoinst "protoinst_files/mipi_block_top.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mipi_block_top.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mipi_block_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mipi_block_top.sh [-help]\n\
Usage: mipi_block_top.sh [-step]\n\
Usage: mipi_block_top.sh [-lib_map_path]\n\
Usage: mipi_block_top.sh [-reset_run]\n\
Usage: mipi_block_top.sh [-reset_log]\n\
Usage: mipi_block_top.sh [-keep_index]\n\
Usage: mipi_block_top.sh [-noclean_files]\n\n\
