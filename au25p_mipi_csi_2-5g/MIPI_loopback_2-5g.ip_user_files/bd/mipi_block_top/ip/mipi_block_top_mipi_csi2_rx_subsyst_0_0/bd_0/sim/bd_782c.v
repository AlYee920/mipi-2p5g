...
//--------------------------------------------------------------------------------
//Command: generate_target bd_782c.bd
//Design : bd_782c
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_782c,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_782c,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "mipi_block_top_mipi_csi2_rx_subsyst_0_0.hwdef" *) 
module bd_782c
   (bg0_pin6_nc,
    bg2_pin6_nc,
    clkoutphy_out,
  ...
  input bg0_pin6_nc;
  input bg2_pin6_nc;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLKOUTPHY_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLKOUTPHY_OUT, CLK_DOMAIN bd_782c_phy_0_clkoutphy_out, FREQ_HZ 2500000000.0, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output clkoutphy_out;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 csirxss_s_axi ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME csirxss_s_axi, ADDR_WIDTH 13, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN mipi_block_top_clk_wiz_0_0_dphy, DATA_WIDTH 32, FREQ_HZ 300000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [12:0]csirxss_s_axi_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.EXT_MMCM_CLK_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.EXT_MMCM_CLK_OUT, CLK_DOMAIN mipi_block_top_mipi_csi2_rx_subsyst_0_0_ext_mmcm_clk_out, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output ext_mmcm_clk_out;
  output ext_mmcm_lock_out;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.LITE_ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.LITE_ACLK, ASSOCIATED_BUSIF csirxss_s_axi, ASSOCIATED_RESET lite_aresetn, CLK_DOMAIN mipi_block_top_clk_wiz_0_0_dphy, FREQ_HZ 300000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input lite_aclk;
  ...
  output pll_lock_out;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.RXBYTECLKHS CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.RXBYTECLKHS, CLK_DOMAIN bd_782c_phy_0_rxbyteclkhs, FREQ_HZ 312500000.0, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0" *) output rxbyteclkhs;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.RXBYTECLKHS_CNTS_OUT CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.RXBYTECLKHS_CNTS_OUT, CLK_DOMAIN mipi_block_top_mipi_csi2_rx_subsyst_0_0_rxbyteclkhs_cnts_out, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output rxbyteclkhs_cnts_out;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.VIDEO_ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.VIDEO_ACLK, ASSOCIATED_BUSIF video_out, ASSOCIATED_RESET video_aresetn, CLK_DOMAIN mipi_block_top_clk_wiz_0_0_dphy, FREQ_HZ 450000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input video_aclk;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 video_out TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME video_out, CLK_DOMAIN mipi_block_top_clk_wiz_0_0_dphy, FREQ_HZ 450000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 2, TDEST_WIDTH 10, TID_WIDTH 0, TUSER_WIDTH 96" *) output [15:0]video_out_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 video_out TUSER" *) output [95:0]video_out_tuser;
  ...
  wire phy_dl0_rxskewcalhs;
  wire phy_dl1_rxskewcalhs;
  wire phy_dl2_rxskewcalhs;
  wire phy_dl3_rxskewcalhs;
  wire phy_ext_mmcm_clk_out;
  wire phy_ext_mmcm_lock_out;
  ...
  assign bg0_pin6_nc_1 = bg0_pin6_nc;
  assign bg2_pin6_nc_1 = bg2_pin6_nc;
  ...
  assign ext_mmcm_clk_out = phy_ext_mmcm_clk_out;
  assign ext_mmcm_lock_out = phy_ext_mmcm_lock_out;
  ...
  assign rxbyteclkhs_cnts_out = phy_rxbyteclkhs_cnts;
  ...
  assign video_out_tuser[95:0] = vfb_0_m_vfb_TUSER;
  assign video_out_tvalid = vfb_0_m_vfb_TVALID;
  bd_782c_phy_0 phy
       (.bg0_pin6_nc(bg0_pin6_nc_1),
        .bg2_pin6_nc(bg2_pin6_nc_1),
        ...
        .dl0_rxskewcalhs(phy_dl0_rxskewcalhs),
        ...
        .dl1_rxskewcalhs(phy_dl1_rxskewcalhs),
        ...
        .dl2_rxskewcalhs(phy_dl2_rxskewcalhs),
        ...
        .dl3_rxskewcalhs(phy_dl3_rxskewcalhs),
        ...
        .ext_mmcm_clk_out(phy_ext_mmcm_clk_out),
        .ext_mmcm_lock_out(phy_ext_mmcm_lock_out),
        .pll_lock_out(phy_pll_lock_out),
        .rxbyteclkhs(phy_rxbyteclkhs),
        .rxbyteclkhs_cnts(phy_rxbyteclkhs_cnts),
  ...
  bd_782c_rx_0 rx
       (.cl_enable(phy_rx_mipi_ppi_if_CL_ENABLE),
        ...
        .m_axis_aclk(phy_rxbyteclkhs_cnts),
  ...
  bd_782c_vfb_0_0 vfb_0
       (.core_men_ack_vfb(vfb_0_core_men_ack_vfb),
        .core_men_vfb(rx_core_men_vfb),
        .mdt_tr(vfb_0_mdt_tr),
        .mdt_tv(vfb_0_mdt_tv),
        .s_axis_aclk(phy_rxbyteclkhs_cnts),
        ...
        .vfb_wc_full(vfb_0_vfb_wc_full));
  bd_782c_vfb_sync_0 vfb_sync
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(video_aresetn_1),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(phy_rxbyteclkhs_cnts));
  bd_782c_xbar_0 xbar
       (.aclk(lite_aclk_1),
