...
(* CORE_GENERATION_INFO = "mipi_block_top,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mipi_block_top,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=12,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,synth_mode=OOC_per_BD}" *) (* HW_HANDOFF = "mipi_block_top.hwdef" *) 
module mipi_block_top
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:mipi_phy:1.0 mipi_phy_if_0 DATA_N" *) output [0:0]mipi_phy_if_0_data_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:mipi_phy:1.0 mipi_phy_if_0 DATA_P" *) output [0:0]mipi_phy_if_0_data_p;
  ...
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire [15:0]golden_data;
  ...
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire [15:0]mipi_csi2_rx_subsyst_0_video_out_tdata1;
  ...
  wire [0:0]mipi_csi2_tx_subsyst_0_mipi_phy_if_DATA_N;
  wire [0:0]mipi_csi2_tx_subsyst_0_mipi_phy_if_DATA_P;
  wire mipi_phy_if_1_CLK_N;
  wire mipi_phy_if_1_CLK_P;
  wire [3:0]mipi_phy_if_1_DATA_N;
  wire [3:0]mipi_phy_if_1_DATA_P;
  wire [5:0]mipi_top_0_mipi_vid_di_tx;
  wire mipi_top_0_mipi_vid_enable_tx;
  wire [15:0]mipi_top_0_mipi_vid_framenum_tx;
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire mipi_top_0_mipi_vid_hsync_tx;
  wire [15:0]mipi_top_0_mipi_vid_linenum_tx;
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire [41:0]mipi_top_0_mipi_vid_pixeldata_tx;
  wire mipi_top_0_mipi_vid_tready_rx;
  wire [1:0]mipi_top_0_mipi_vid_vc_tx;
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire mipi_top_0_mipi_vid_vsync_tx;
  wire [15:0]mipi_top_0_mipi_vid_wc_tx;
  (* DEBUG = "true" *) (* MARK_DEBUG *) wire [15:0]mipi_top_0_rx_unpack_data;
  wire oddr_0_clk_out;
  ...
  assign mipi_phy_if_0_data_n[0] = mipi_csi2_tx_subsyst_0_mipi_phy_if_DATA_N;
  assign mipi_phy_if_0_data_p[0] = mipi_csi2_tx_subsyst_0_mipi_phy_if_DATA_P;
  ...
  mipi_block_top_mipi_csi2_tx_subsyst_0_0 mipi_csi2_tx_subsyst_0
       (.dphy_clk_200M(clk_wiz_0_dphy),
        ...
        .mipi_video_if_mipi_vid_di(mipi_top_0_mipi_vid_di_tx),
        .mipi_video_if_mipi_vid_enable(mipi_top_0_mipi_vid_enable_tx),
        .mipi_video_if_mipi_vid_framenum(mipi_top_0_mipi_vid_framenum_tx),
        .mipi_video_if_mipi_vid_hsync(mipi_top_0_mipi_vid_hsync_tx),
        .mipi_video_if_mipi_vid_linenum(mipi_top_0_mipi_vid_linenum_tx),
        .mipi_video_if_mipi_vid_pixel(mipi_top_0_mipi_vid_pixeldata_tx),
        .mipi_video_if_mipi_vid_vc(mipi_top_0_mipi_vid_vc_tx),
        .mipi_video_if_mipi_vid_vsync(mipi_top_0_mipi_vid_vsync_tx),
        .mipi_video_if_mipi_vid_wc(mipi_top_0_mipi_vid_wc_tx),
        ...
        .s_axis_aclk(clk_wiz_0_axi_clk),
        .s_axis_aresetn(xlconstant_1_dout));
  mipi_block_top_mipi_top_0_0 mipi_top_0
       (.error_cnt(error_cnt),
        .golden_data(golden_data),
        .mipi_vid_di_tx(mipi_top_0_mipi_vid_di_tx),
        .mipi_vid_enable_tx(mipi_top_0_mipi_vid_enable_tx),
        .mipi_vid_framenum_tx(mipi_top_0_mipi_vid_framenum_tx),
        .mipi_vid_hsync_tx(mipi_top_0_mipi_vid_hsync_tx),
        .mipi_vid_linenum_tx(mipi_top_0_mipi_vid_linenum_tx),
        .mipi_vid_pixeldata_tx(mipi_top_0_mipi_vid_pixeldata_tx),
        ...
        .mipi_vid_vc_tx(mipi_top_0_mipi_vid_vc_tx),
        .mipi_vid_vsync_tx(mipi_top_0_mipi_vid_vsync_tx),
        .mipi_vid_wc_tx(mipi_top_0_mipi_vid_wc_tx),
  ...
  mipi_block_top_system_ila_0_1 system_ila_0
       (.clk(clk_wiz_0_dbg_clk),
        ...
        .probe1(mipi_top_0_mipi_vid_hsync_tx),
        .probe2(mipi_top_0_mipi_vid_pixeldata_tx),
        .probe3(mipi_top_0_mipi_vid_vsync_tx),
        .probe4(error_cnt),
        .probe5(golden_data),
        .probe6(mipi_top_0_rx_unpack_data),
        .probe7(mipi_csi2_rx_subsyst_0_video_out_tvalid));
