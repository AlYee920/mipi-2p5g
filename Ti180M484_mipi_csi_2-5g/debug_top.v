...
module edb_top (
    ...
    output bscan_TDO,
    input  vio0_clk,
    input  [47:0] vio0_txdata,
    input  [23:0] vio0_rxunpackdata,
    input  vio0_rxoutvalid,
    input  vio0_rxouths,
    input  [7:0] vio0_error
);
    ...
    edb_vio_top #(
        .NUM_PROBE_IN           ( 5 ),
        .NUM_PROBE_OUT          ( 0 ),
        .UUID           ( 128'h45cacc2aca884ad185aea3feabd0d1c1 ),
        .PROBE_IN0_WIDTH        ( 48 ),
        .PROBE_IN1_WIDTH        ( 24 ),
        .PROBE_IN2_WIDTH        ( 1 ),
        .PROBE_IN3_WIDTH        ( 1 ),
        ...
        .clk                ( vio0_clk ),
        .probe_in0          ( vio0_txdata ),
        .probe_in1          ( vio0_rxunpackdata ),
        .probe_in2          ( vio0_rxoutvalid ),
        .probe_in3          ( vio0_rxouths ),
