...
module top #(   //csi2 example design
    ...
    parameter HSA		 = 2,  //minimum value is pixel cnt value, eg: RGB888 - 2
    parameter HBP		 = 2,   //minimum value is pixel cnt value, eg: RGB888 - 2
    parameter HFP		 = 1080,
    ...
    parameter DATATYPE = 6'h24     //24 - RGB888 2A-RAW8
)(
input 			reset_n,  //sw5
output [3:0]    led,
...
//output  logic       mipi_dphy_tx_inst1_ESC_CLK, // do not need to output to DPHY, will connect direct from pll.
...
//output  logic       mipi_dphy_rx_inst2_CAL_CLK, // do not need to output to DPHY, will connect direct from pll.
...
localparam PIXEL_FIFO_DEPTH = 4096;  //set to a power of 2 value that is bigger than HACT_CNT
